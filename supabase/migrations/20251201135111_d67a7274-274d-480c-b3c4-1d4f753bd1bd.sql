-- Update the handle_new_user function to assign specific roles based on names
...
BEGIN
  ...
  -- Check for moderator users
  IF user_full_name IN ('stacy hill', 'sakshi', 'patrick') THEN
    INSERT INTO public.user_roles (user_id, role)
