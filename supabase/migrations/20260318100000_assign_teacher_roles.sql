...
WITH teacher_emails(email) AS (
  VALUES
    ...
    ('damien.vassallo@ntare-louisenlund.org'),
    ...
    ('ryan.james@ntare-louisenlund.org'),
    ...
    ('svenja.budziak@ntare-louisenlund.org')
),
matched AS (
...
INNER JOIN (
  VALUES
    ...
    ('stacy.hill@ntare-louisenlund.org'),
    ('svenja.budziak@ntare-louisenlund.org')
) AS te(email) ON lower(au.email) = lower(te.email)
